        ...
        <div className="col-md-3">
            <div className="card border-white text-start mt-2 shadow">
                <div className="card-body">
                    <div className="card-title fw-bold"><h5>{skill.name}</h5></div>
                    <div className="card-subtitle mb-2 text-body-secondary">{skill.category}</div>
                    <div className="progress" role="progressbar" aria-label="Warning example" aria-valuenow={skill.rate} aria-valuemin="0" aria-valuemax="100">
